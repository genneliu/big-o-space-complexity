...
// ANSWER: They both depend on an n 
...
console.time("not memo: ");
console.log(nonCacheCalcFac(6))
console.log(nonCacheCalcFac(6))
console.log(nonCacheCalcFac(6))
console.log(nonCacheCalcFac(6))
console.timeEnd("not memo: ");

console.time("memo: ");
console.log(myFac.calcFac(6))
console.log(myFac.calcFac(6))
console.log(myFac.calcFac(6))
console.log(myFac.calcFac(6))
...
function nonCacheAddThreeNums(n1, n2, n3) {
  let answer = n1 + n2 + n3
  return answer
}
...
const anotherInstance = new AddWithCache()

console.time("not memoized function time");
console.log(nonCacheAddThreeNums(3,4,5))
console.log(nonCacheAddThreeNums(3,4,5))
console.log(nonCacheAddThreeNums(3,4,5))
console.log(nonCacheAddThreeNums(3,4,5))
...
console.log(anotherInstance.addThreeNums(3,4,5))
console.log(anotherInstance.addThreeNums(3,4,5))
console.log(anotherInstance.addThreeNums(3,4,5))
console.log(anotherInstance.addThreeNums(3,4,5))
